...
void __init shooteru_gpio_mpp_init(void)
{
	...
	struct pm8xxx_gpio_init gpio_cfgs[] = {
          PM8XXX_GPIO_INIT(PM8058_GPIO_PM_TO_SYS(SHOOTERU_SDC3_DET),
