...
static struct regulator *shooteru_reg_8058_l9 = NULL;
static struct regulator *shooteru_reg_8058_l10 = NULL;
static struct regulator *shooteru_reg_8058_l12 = NULL;
static struct regulator *shooteru_reg_8058_l15 = NULL;
...
static uint32_t camera_off_gpio_table[] = {
	GPIO_CFG(SHOOTERU_CAM1_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM2_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM2_PWDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM_MCLK, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
	GPIO_CFG(SHOOTERU_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
	GPIO_CFG(SHOOTERU_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTERU_MCLK_SWITCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM_CAM1_ID, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
};

static uint32_t camera_on_gpio_table[] = {
	GPIO_CFG(SHOOTERU_CAM_I2C_SDA, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_4MA),
	GPIO_CFG(SHOOTERU_CAM_I2C_SCL, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_8MA),
	GPIO_CFG(SHOOTERU_CAM_MCLK, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_16MA),
	GPIO_CFG(SHOOTERU_CAM1_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM2_RSTz, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_CAM2_PWDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	GPIO_CFG(SHOOTERU_MCLK_SWITCH, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
...
static uint32_t camera_on_gpio_table_workaround[] = {
	GPIO_CFG(SHOOTERU_CAM_I2C_SDA, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_4MA),
	GPIO_CFG(SHOOTERU_CAM_I2C_SCL, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_8MA),
};
#endif
...
static int shooteru_config_camera_on_gpios(void)
{
...
#ifdef CONFIG_S5K3H1GX
static int shooteru_s5k3h1gx_vreg_on(void)
{
	...
	if (first_run == 1) {
		...
		rc = camera_sensor_power_enable("8058_l10", 2850000, &shooteru_reg_8058_l10);
		...
		rc = camera_sensor_power_enable("8058_l12", 1800000, &shooteru_reg_8058_l12);
		...
		rc = camera_sensor_power_enable("8058_l15", 2800000, &shooteru_reg_8058_l15);
		...
		rc = camera_sensor_power_enable("8058_l9", 1800000, &shooteru_reg_8058_l9);
		...
		rc = camera_sensor_power_disable(shooteru_reg_8058_l9);
		...
		rc = camera_sensor_power_disable(shooteru_reg_8058_l15);
		...
		rc = camera_sensor_power_disable(shooteru_reg_8058_l12);
		...
		rc = camera_sensor_power_disable(shooteru_reg_8058_l10);
		if (rc < 0) {
	...
	shooteru_config_camera_on_gpios();

init_fail:
	return rc;
}

static int shooteru_s5k3h1gx_vreg_off(void)
{
	int rc = 0;
	...
	shooteru_config_camera_off_gpios();
...
static struct msm_camera_sensor_platform_info sensor_s5k3h1gx_board_info = {
	...
	.sensor_reset	= SHOOTERU_CAM1_RSTz,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k3h1gx_data = {
	...
	.camera_power_on = shooteru_s5k3h1gx_vreg_on,
	.camera_power_off = shooteru_s5k3h1gx_vreg_off,
...
static int shooteru_mt9v113_vreg_on(void)
{
	int rc = 0;
	...
	rc = gpio_request(SHOOTERU_MCLK_SWITCH, "CAM_SEL");
	if (rc < 0)
	{
		pr_err("[CAM] GPIO (%d) request fail\n", SHOOTERU_MCLK_SWITCH);
		goto init_fail;
	}
	gpio_direction_output(SHOOTERU_MCLK_SWITCH, 1);
	gpio_free(SHOOTERU_MCLK_SWITCH);

init_fail:
	return rc;
}

static int shooteru_mt9v113_vreg_off(void)
{
	int rc = 0;
	...
	gpio_direction_output(SHOOTERU_MCLK_SWITCH, 0);
	gpio_free(SHOOTERU_MCLK_SWITCH);
...
static struct msm_camera_sensor_platform_info sensor_mt9v113_board_info = {
	...
	.sensor_reset_enable = 1,
	.sensor_reset = SHOOTERU_CAM2_RSTz,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_mt9v113_data = {
	.sensor_name	= "mt9v113",
	.sensor_reset	= SHOOTERU_CAM2_RSTz,
	.camera_power_on = shooteru_mt9v113_vreg_on,
	.camera_power_off = shooteru_mt9v113_vreg_off,
