...
static int __init mipi_cmd_shooteru_qhd_pt_init(void)
{
	int ret;
	...
	ret = mipi_shooteru_device_register(&pinfo, MIPI_DSI_PRIM,
...
//late_initcall(mipi_cmd_shooteru_qhd_pt_init);
device_initcall_sync(mipi_cmd_shooteru_qhd_pt_init);
