...
static struct msm_gpiomux_config shooteru_gsbi_configs[] __initdata = {
	{
		.gpio      = 44,		
		.settings = {
...
void __init shooteru_init_gpiomux(void)
{
	int rc;
	...
	msm_gpiomux_install(shooteru_gsbi_configs,
			ARRAY_SIZE(shooteru_gsbi_configs));
}
